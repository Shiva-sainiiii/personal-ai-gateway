...
export const MODEL_REGISTRY = {
  TEXT: [
    { provider: "groq", model: "llama-3.3-70b-versatile", contextWindow: 131072, note: "coding/reasoning, Groq default" },
  ...
  VISION: [
    { provider: "groq", model: "meta-llama/llama-4-scout-17b-16e-instruct", contextWindow: 131072, note: "native multimodal on Groq" },
  ...
  ADDITIONAL_LIVE_POOL: [
    ...
    { provider: "groq", model: "qwen/qwen3-32b", contextWindow: 131072, note: "coding and advanced logic" },
