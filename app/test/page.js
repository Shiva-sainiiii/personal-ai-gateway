...
export default function TestPage() {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 720, margin: "0 auto", fontFamily: "system-ui, sans-serif", color: "#e6e8eb" }}>
      <h1 style={{ color: "#e6e8eb" }}>Gateway MVP Test</h1>
      <p style={{ opacity: 0.7 }}>
...
const box = { position: "relative", zIndex: 1, isolation: "isolate", overflow: "hidden", border: "1px solid #232b38", borderRadius: 10, padding: 16, marginBottom: 16, background: "#141922" };
const input = { display: "block", width: "100%", padding: 10, marginBottom: 8, borderRadius: 6, border: "1px solid #2a3341", background: "#0b0e14", color: "#e6e8eb", boxSizing: "border-box" };
